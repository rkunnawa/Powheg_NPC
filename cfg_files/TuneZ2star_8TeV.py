...
process.source = cms.Source("LHESource",
			 fileNames = cms.untracked.vstring('file:powheg.lhe')
                    )
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/MinBias_TuneZ2star_7TeV_pythia6_cff.py,v $')
)
...
def customise(process):
        ...
        process.rivetAnalyzer.AnalysisNames = cms.vstring('CMS_DIJETS_8TEV') 	
